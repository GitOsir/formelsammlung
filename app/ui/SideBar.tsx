                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        </button>
                        {
                            sideBarTopics.map(({link,icon})=>(
                                <button onClick={()=>scrollTo(link)} className="flex items-center justify-center mx-3 size-10 hover:bg-slate-300/55 hover:border-2 hover:border-slate-300 rounded-md ">
                        ...
                        <div className="flex px-3 flex-col gap-3">
                            ...
                            </div>
                            {
                                ...
                                sideBarTopics.map((topic)=>{
                                    return (
                                    <>
                                    <div className="flex flex-row justify-between hover:bg-slate-300 rounded-md px-2 py-2 w-[200px]">
                                        <div className="flex flex-row gap-1">
                                            <Image width={30} height={30} alt="icon" src={topic.icon != null?topic.icon:""}></Image>
                                            <button onClick={()=>scrollTo(topic.link)} className="text-left">{topic.name}</button>
                                        </div>
